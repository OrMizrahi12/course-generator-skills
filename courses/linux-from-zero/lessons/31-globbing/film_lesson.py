#!/usr/bin/env python3
"""Film lesson 31: create a set of .txt files, miss with a quoted *, catch with glob."""
...
VIZ = ROOT / "viz/renders/lesson-31-viz.mp4"
OUT = ROOT / "lesson-31.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson31-ffmpeg.log", "w")
    ...
    time.sleep(2.2)
    h.type_line("touch /home/ubuntu/rent-receipts/late-notice.txt")
    time.sleep(1.6)
    h.type_line("touch /home/ubuntu/rent-receipts/landlord-note.txt")
    time.sleep(1.6)
    h.type_line("ls -l '/home/ubuntu/rent-receipts/*.txt'")
    time.sleep(2.4)
    h.type_line("ls -l /home/ubuntu/rent-receipts/*.txt")
    time.sleep(5.4)
