#!/usr/bin/env python3
"""Film lesson 18: Ubuntu LTS pictures, then PRETTY_NAME and UBUNTU_CODENAME from os-release."""
...
VIZ = ROOT / "viz/renders/lesson-18-viz.mp4"
OUT = ROOT / "lesson-18.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("grep PRETTY_NAME= /etc/os-release", 0.4, 3.4),
    ("grep UBUNTU_CODENAME= /etc/os-release", 0.5, 4.8),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson18-ffmpeg.log", "w")
