#!/usr/bin/env python3
"""Film lesson 12: vendor OS pictures, then ls /etc and cat /proc/version."""
...
VIZ = ROOT / "viz/renders/lesson-12-viz.mp4"
OUT = ROOT / "lesson-12.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ls /etc", 0.8, 3.6),
    ("cat /proc/version", 0.6, 4.2),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson12-ffmpeg.log", "w")
