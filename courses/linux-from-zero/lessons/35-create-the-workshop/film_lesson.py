#!/usr/bin/env python3
"""Film lesson 35: mkdir ~/linux-workshop and prove it."""
...
VIZ = ROOT / "viz/renders/lesson-35-viz.mp4"
OUT = ROOT / "lesson-35.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    if Path("/home/ubuntu/linux-workshop").exists():
        raise SystemExit("linux-workshop already exists; reset before filming")
    ...
    log = open("/tmp/lesson35-ffmpeg.log", "w")
    ...
    h.type_line("pwd")
    time.sleep(1.6)
    h.type_line("mkdir ~/linux-workshop")
    time.sleep(1.6)
    h.type_line("ls ~")
    time.sleep(2.2)
