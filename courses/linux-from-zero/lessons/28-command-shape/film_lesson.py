#!/usr/bin/env python3
"""Film lesson 28: open Terminal Emulator, type ls -ld on rent-receipts, hold the line."""
...
VIZ = ROOT / "viz/renders/lesson-28-viz.mp4"
OUT = ROOT / "lesson-28.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson28-ffmpeg.log", "w")
