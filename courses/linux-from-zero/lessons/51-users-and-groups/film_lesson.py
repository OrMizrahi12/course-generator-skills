#!/usr/bin/env python3
"""Film lesson 51: groups, id -nG, and grep ubuntu /etc/group."""
...
VIZ = ROOT / "viz/renders/lesson-51-viz.mp4"
OUT = ROOT / "lesson-51.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson51-ffmpeg.log", "w")
    ...
    h.type_line("id -nG")
    time.sleep(1.6)
    h.type_line("getent group sudo")
    time.sleep(1.6)
    h.type_line("grep ubuntu /etc/group")
    time.sleep(6.0)
