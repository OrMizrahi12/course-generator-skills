#!/usr/bin/env python3
"""Film lesson 50: whoami, id, and this account's passwd line."""
...
VIZ = ROOT / "viz/renders/lesson-50-viz.mp4"
OUT = ROOT / "lesson-50.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson50-ffmpeg.log", "w")
    ...
    h.type_line("id")
    time.sleep(1.8)
    h.type_line("getent passwd ubuntu")
    time.sleep(6.0)
