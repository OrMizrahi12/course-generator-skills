#!/usr/bin/env python3
"""Film lesson 19: Fedora/RHEL pictures, then ls /usr/bin/apt and ls /usr/bin/dnf."""
...
VIZ = ROOT / "viz/renders/lesson-19-viz.mp4"
OUT = ROOT / "lesson-19.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ls /usr/bin/apt", 0.4, 2.8),
    ("ls /usr/bin/dnf", 0.5, 5.0),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson19-ffmpeg.log", "w")
