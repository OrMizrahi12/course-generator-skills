#!/usr/bin/env python3
"""Film lesson 34: cd absolute, relative ., and parent .."""
...
VIZ = ROOT / "viz/renders/lesson-34-viz.mp4"
OUT = ROOT / "lesson-34.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson34-ffmpeg.log", "w")
    ...
    h.type_line("pwd")
    time.sleep(1.6)
    h.type_line("cd /home/ubuntu")
    time.sleep(1.4)
    h.type_line("pwd")
    time.sleep(1.6)
    h.type_line("cd ./rent-receipts")
    time.sleep(1.4)
    h.type_line("pwd")
    time.sleep(1.6)
    h.type_line("ls")
