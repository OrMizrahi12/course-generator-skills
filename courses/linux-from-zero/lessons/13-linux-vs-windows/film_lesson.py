#!/usr/bin/env python3
"""Film lesson 13: Windows pictures, then ls / and pwd — one tree, no C:."""
...
VIZ = ROOT / "viz/renders/lesson-13-viz.mp4"
OUT = ROOT / "lesson-13.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ls /", 0.8, 3.6),
    ("pwd", 0.5, 4.2),
...
def main() -> None:
    ...
    log = open("/tmp/lesson13-ffmpeg.log", "w")
