#!/usr/bin/env python3
"""Film lesson 92: /var/log then dmesg."""
...
VIZ = ROOT / "viz/renders/lesson-92-viz.mp4"
OUT = ROOT / "lesson-92.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson92-ffmpeg.log", "w")
    ...
    time.sleep(1.4)
    h.type_line("ls /var/log")
    time.sleep(2.2)
    h.type_line("tail -n 6 /var/log/apt/history.log")
    time.sleep(2.4)
    h.type_line("dmesg | head -n 1")
    time.sleep(6.0)
