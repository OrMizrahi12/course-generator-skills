#!/usr/bin/env python3
"""Film lesson 26: open Terminal Emulator from the desktop, type date, hold the line."""
...
VIZ = ROOT / "viz/renders/lesson-26-viz.mp4"
OUT = ROOT / "lesson-26.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson26-ffmpeg.log", "w")
