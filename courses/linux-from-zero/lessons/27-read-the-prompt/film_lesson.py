#!/usr/bin/env python3
"""Film lesson 27: open Terminal Emulator, decode prompt with id -un, uname -n, pwd."""
...
VIZ = ROOT / "viz/renders/lesson-27-viz.mp4"
OUT = ROOT / "lesson-27.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson27-ffmpeg.log", "w")
