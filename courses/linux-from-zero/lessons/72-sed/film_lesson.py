#!/usr/bin/env python3
"""Film lesson 72: sed s/Sep/Oct/ on rent-log.txt stdout."""
...
VIZ = ROOT / "viz/renders/lesson-72-viz.mp4"
OUT = ROOT / "lesson-72.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson72-ffmpeg.log", "w")
    ...
    time.sleep(1.6)
    h.type_line("sed 's/Sep/Oct/' rent-log.txt")
    time.sleep(6.0)
