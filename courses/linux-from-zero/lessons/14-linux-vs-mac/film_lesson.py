#!/usr/bin/env python3
"""Film lesson 14: Darwin/Mac pictures, then uname -s and cat /etc/os-release."""
...
VIZ = ROOT / "viz/renders/lesson-14-viz.mp4"
OUT = ROOT / "lesson-14.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("uname -s", 0.5, 3.2),
    ("cat /etc/os-release", 0.7, 4.8),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson14-ffmpeg.log", "w")
