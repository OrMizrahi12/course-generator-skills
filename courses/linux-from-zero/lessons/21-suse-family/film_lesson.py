#!/usr/bin/env python3
"""Film lesson 21: SUSE family pictures, then ls /usr/bin/apt and ls /usr/bin/zypper."""
...
VIZ = ROOT / "viz/renders/lesson-21-viz.mp4"
OUT = ROOT / "lesson-21.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ls /usr/bin/apt", 0.4, 2.8),
    ("ls /usr/bin/zypper", 0.5, 5.0),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson21-ffmpeg.log", "w")
