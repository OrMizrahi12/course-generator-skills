#!/usr/bin/env python3
"""Film lesson 94: GRUB picture, /proc/cmdline, PID 1 is tini."""
...
VIZ = ROOT / "viz/renders/lesson-94-viz.mp4"
OUT = ROOT / "lesson-94.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson94-ffmpeg.log", "w")
    ...
    time.sleep(1.4)
    h.type_line("ls -la /boot")
    time.sleep(2.2)
    h.type_line("cat /proc/cmdline")
    time.sleep(3.2)
    h.type_line("ps -p 1 -o pid,comm")
    time.sleep(2.2)
