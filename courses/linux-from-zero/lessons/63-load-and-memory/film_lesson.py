#!/usr/bin/env python3
"""Film lesson 63: free -h then top while sha256sum /dev/zero runs."""
...
VIZ = ROOT / "viz/renders/lesson-63-viz.mp4"
OUT = ROOT / "lesson-63.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson63-ffmpeg.log", "w")
