#!/usr/bin/env python3
"""Film lesson 99: dated workshop backup plus log."""
...
VIZ = ROOT / "viz/renders/lesson-99-viz.mp4"
OUT = ROOT / "lesson-99.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson99-ffmpeg.log", "w")
    ...
    h.type_line("date +%F")
    time.sleep(1.8)
    h.type_line("./snap.sh ../workshop-2026-08-22.tar.gz")
    time.sleep(2.2)
    h.type_line("mv ../workshop-2026-08-22.tar.gz .")
    time.sleep(1.6)
    h.type_line("ls -l workshop-2026-08-22.tar.gz")
    time.sleep(2.0)
    h.type_line("date '+%F %T workshop-2026-08-22.tar.gz' >> workshop-backup.log")
    time.sleep(1.8)
    h.type_line("cat workshop-backup.log")
    time.sleep(6.0)
