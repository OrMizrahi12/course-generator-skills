#!/usr/bin/env python3
"""Film lesson 79: file pstree, then ldd lists shared libraries."""
...
VIZ = ROOT / "viz/renders/lesson-79-viz.mp4"
OUT = ROOT / "lesson-79.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson79-ffmpeg.log", "w")
    ...
    h.type_line("cd ~")
    time.sleep(1.2)
    h.type_line("file /usr/bin/pstree")
    time.sleep(2.2)
    h.type_line("ldd /usr/bin/pstree")
    time.sleep(6.0)
