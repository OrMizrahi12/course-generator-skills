#!/usr/bin/env python3
"""Film lesson 15: Linux-everywhere pictures, then hostname and uname -a."""
...
VIZ = ROOT / "viz/renders/lesson-15-viz.mp4"
OUT = ROOT / "lesson-15.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("hostname", 0.4, 2.8),
    ("uname -a", 0.6, 4.8),
...
def main() -> None:
    ...
    log = open("/tmp/lesson15-ffmpeg.log", "w")
