#!/usr/bin/env python3
"""Film lesson 95: systemd usual init, tini here, read dbus.service."""
...
VIZ = ROOT / "viz/renders/lesson-95-viz.mp4"
OUT = ROOT / "lesson-95.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson95-ffmpeg.log", "w")
    ...
    time.sleep(1.4)
    h.type_line("systemctl is-system-running")
    time.sleep(2.2)
    h.type_line("cat /proc/1/comm")
    time.sleep(2.0)
    h.type_line("ls /lib/systemd/system/dbus.service")
    time.sleep(2.2)
    h.type_line("cat /lib/systemd/system/dbus.service")
    time.sleep(7.0)
