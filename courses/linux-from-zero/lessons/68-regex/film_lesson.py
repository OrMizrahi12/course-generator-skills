#!/usr/bin/env python3
"""Film lesson 68: regex grep '^21 ' on the rent log."""
...
VIZ = ROOT / "viz/renders/lesson-68-viz.mp4"
OUT = ROOT / "lesson-68.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson68-ffmpeg.log", "w")
    ...
    time.sleep(1.5)
    h.type_line("grep 21 rent-log.txt")
    time.sleep(1.6)
    h.type_line("grep '^21 ' rent-log.txt")
    time.sleep(6.0)
