#!/usr/bin/env python3
"""Film lesson 80: write due.c, gcc -o due, run ./due."""
...
VIZ = ROOT / "viz/renders/lesson-80-viz.mp4"
OUT = ROOT / "lesson-80.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson80-ffmpeg.log", "w")
