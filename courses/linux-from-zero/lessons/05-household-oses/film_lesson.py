#!/usr/bin/env python3
"""Film lesson 5: three household OS families, then prove this screen is Linux."""
...
VIZ = ROOT / "viz/renders/lesson-05-viz.mp4"
OUT = ROOT / "lesson-05.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("cat /proc/sys/kernel/ostype", 0.6, 2.6),
    ("ls /usr/share/xsessions", 0.7, 3.4),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson05-ffmpeg.log", "w")
