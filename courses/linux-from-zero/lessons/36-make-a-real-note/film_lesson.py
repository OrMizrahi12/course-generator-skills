#!/usr/bin/env python3
"""Film lesson 36: write a real rent log in nano, then Write Out."""
...
VIZ = ROOT / "viz/renders/lesson-36-viz.mp4"
OUT = ROOT / "lesson-36.mp4"
W, H = 1920, 1080
NOTE = Path("/home/ubuntu/linux-workshop/rent-log.txt")
...
NOTE_TEXT = (
    "21 Aug rent is paid.\n"
    "Keep the three papers in /home/ubuntu/rent-receipts.\n"
    "Next due 21 Sep.\n"
)
...
def main() -> None:
    ...
    if not Path("/home/ubuntu/linux-workshop").is_dir():
        raise SystemExit("linux-workshop missing; lesson 35 must exist")
    if NOTE.exists():
        raise SystemExit("rent-log.txt already exists; reset before filming")
    ...
    log = open("/tmp/lesson36-ffmpeg.log", "w")
