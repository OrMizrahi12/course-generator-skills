#!/usr/bin/env python3
"""Film lesson 32: pwd, tilde, $HOME, prove rent-receipts lives under home."""
...
VIZ = ROOT / "viz/renders/lesson-32-viz.mp4"
OUT = ROOT / "lesson-32.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson32-ffmpeg.log", "w")
    ...
    h.type_line("ls -ld ~")
    time.sleep(2.2)
    h.type_line('ls -ld "$HOME"')
    time.sleep(2.2)
    h.type_line('ls -ld "$HOME/rent-receipts"')
    time.sleep(5.4)
