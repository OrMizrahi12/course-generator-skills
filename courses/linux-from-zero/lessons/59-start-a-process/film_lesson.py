#!/usr/bin/env python3
"""Film lesson 59: start tail -f rent-log.txt and find it with ps."""
...
VIZ = ROOT / "viz/renders/lesson-59-viz.mp4"
OUT = ROOT / "lesson-59.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson59-ffmpeg.log", "w")
