#!/usr/bin/env python3
"""Film lesson 4: four OS jobs viz, then match files/programs/users/devices."""
...
VIZ = ROOT / "viz/renders/lesson-04-viz.mp4"
OUT = ROOT / "lesson-04.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("whoami", 0.5, 2.0),
    ("ls /home/ubuntu", 0.6, 2.2),
    ("ps -o pid,comm", 0.7, 2.4),
    ("ls /dev/vda /dev/null /dev/tty", 0.7, 4.2),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson04-ffmpeg.log", "w")
