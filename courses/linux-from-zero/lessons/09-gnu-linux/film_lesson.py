#!/usr/bin/env python3
"""Film lesson 9: GNU/Linux whole-system pictures, then uname -r and ls --version."""
...
VIZ = ROOT / "viz/renders/lesson-09-viz.mp4"
OUT = ROOT / "lesson-09.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("uname -r", 0.5, 2.4),
    ("ls --version", 0.8, 4.8),
...
def main() -> None:
    ...
    log = open("/tmp/lesson09-ffmpeg.log", "w")
