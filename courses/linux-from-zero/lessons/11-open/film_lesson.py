#!/usr/bin/env python3
"""Film lesson 11: four freedoms, then open GPL-3 on this disk."""
...
VIZ = ROOT / "viz/renders/lesson-11-viz.mp4"
OUT = ROOT / "lesson-11.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ls /usr/share/common-licenses", 0.8, 3.2),
    ("head -n 20 /usr/share/common-licenses/GPL-3", 0.8, 5.2),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson11-ffmpeg.log", "w")
