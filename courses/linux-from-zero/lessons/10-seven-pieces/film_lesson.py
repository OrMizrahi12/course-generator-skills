#!/usr/bin/env python3
"""Film lesson 10: seven OS pieces, then ps PID 1 and xsessions."""
...
VIZ = ROOT / "viz/renders/lesson-10-viz.mp4"
OUT = ROOT / "lesson-10.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ps -p 1 -o pid,comm", 0.6, 2.6),
    ("ls /usr/share/xsessions", 0.6, 3.4),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson10-ffmpeg.log", "w")
