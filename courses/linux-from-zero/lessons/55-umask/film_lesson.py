#!/usr/bin/env python3
"""Film lesson 55: umask, touch sep-due-note.txt, then ls -l."""
...
VIZ = ROOT / "viz/renders/lesson-55-viz.mp4"
OUT = ROOT / "lesson-55.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    leftover = WORK / "sep-due-note.txt"
    if leftover.exists():
        leftover.unlink()
    ...
    log = open("/tmp/lesson55-ffmpeg.log", "w")
    ...
    h.type_line("umask -S")
    time.sleep(1.5)
    h.type_line("touch sep-due-note.txt")
    time.sleep(1.5)
