#!/usr/bin/env python3
"""Film lesson 8: kernel engine pictures, then uname -s and uname -r."""
...
VIZ = ROOT / "viz/renders/lesson-08-viz.mp4"
OUT = ROOT / "lesson-08.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("uname -s", 0.5, 2.2),
    ("uname -r", 0.5, 3.2),
...
def main() -> None:
    ...
    log = open("/tmp/lesson08-ffmpeg.log", "w")
