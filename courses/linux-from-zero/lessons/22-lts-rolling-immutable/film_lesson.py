#!/usr/bin/env python3
"""Film lesson 22: LTS vs rolling vs immutable, then ls /var/lib/dpkg/status and ls /ostree."""
...
VIZ = ROOT / "viz/renders/lesson-22-viz.mp4"
OUT = ROOT / "lesson-22.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ls /var/lib/dpkg/status", 0.4, 2.8),
    ("ls /ostree", 0.5, 5.0),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson22-ffmpeg.log", "w")
