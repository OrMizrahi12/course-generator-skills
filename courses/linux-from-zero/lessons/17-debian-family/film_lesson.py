#!/usr/bin/env python3
"""Film lesson 17: Debian family pictures, then grep ID_LIKE= and dpkg --version."""
...
VIZ = ROOT / "viz/renders/lesson-17-viz.mp4"
OUT = ROOT / "lesson-17.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("grep ID_LIKE= /etc/os-release", 0.4, 3.2),
    ("dpkg --version", 0.6, 5.2),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson17-ffmpeg.log", "w")
