#!/usr/bin/env python3
"""Film lesson 24: name this computer’s exact Linux, then uname -sr, ls --version, grep ID=."""
...
VIZ = ROOT / "viz/renders/lesson-24-viz.mp4"
OUT = ROOT / "lesson-24.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("uname -sr", 0.4, 2.6),
    ("ls --version", 0.45, 2.8),
    ("grep ID= /etc/os-release", 0.5, 5.0),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson24-ffmpeg.log", "w")
