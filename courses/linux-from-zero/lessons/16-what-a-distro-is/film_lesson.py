#!/usr/bin/env python3
"""Film lesson 16: distro pictures, then ls /etc/apt and apt --version."""
...
VIZ = ROOT / "viz/renders/lesson-16-viz.mp4"
OUT = ROOT / "lesson-16.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ls /etc/apt", 0.4, 3.2),
    ("apt --version", 0.6, 4.8),
...
def main() -> None:
    ...
    log = open("/tmp/lesson16-ffmpeg.log", "w")
