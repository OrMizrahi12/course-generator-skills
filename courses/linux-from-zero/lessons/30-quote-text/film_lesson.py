#!/usr/bin/env python3
"""Film lesson 30: unquoted touch splits a spaced name; quotes make one file."""
...
VIZ = ROOT / "viz/renders/lesson-30-viz.mp4"
OUT = ROOT / "lesson-30.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson30-ffmpeg.log", "w")
    ...
    h.click()
    time.sleep(0.45)
    h.type_line("touch /home/ubuntu/rent-receipts/21 Aug receipt.txt")
    time.sleep(1.8)
    h.type_line("ls -l /home/ubuntu/rent-receipts")
    time.sleep(2.2)
    h.type_line("ls -l Aug receipt.txt")
    time.sleep(2.2)
    h.type_line("rm /home/ubuntu/rent-receipts/21 Aug receipt.txt")
    time.sleep(1.6)
    h.type_line("touch '/home/ubuntu/rent-receipts/21 Aug receipt.txt'")
    time.sleep(1.8)
    h.type_line("ls -l '/home/ubuntu/rent-receipts/21 Aug receipt.txt'")
    time.sleep(5.4)
