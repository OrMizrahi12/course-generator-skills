#!/usr/bin/env python3
"""Film lesson 98: overlay /, namespaces, PID 1 cgroup."""
...
VIZ = ROOT / "viz/renders/lesson-98-viz.mp4"
OUT = ROOT / "lesson-98.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson98-ffmpeg.log", "w")
    ...
    h.type_line("df -hT /")
    time.sleep(2.0)
    h.type_line("findmnt -n -o SOURCE,FSTYPE,TARGET /")
    time.sleep(2.0)
    h.type_line("ls /proc/self/ns")
    time.sleep(2.0)
    h.type_line("cat /proc/1/cgroup")
    time.sleep(6.0)
