#!/usr/bin/env python3
"""Film lesson 29: type a command, Up to re-run, Tab-complete file on rent-receipts."""
...
VIZ = ROOT / "viz/renders/lesson-29-viz.mp4"
OUT = ROOT / "lesson-29.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson29-ffmpeg.log", "w")
    ...
    h.click()
    time.sleep(0.45)
    h.type_line("ls -ld /home/ubuntu/rent-receipts")
    time.sleep(2.3)
    h.press_up()
    time.sleep(1.1)
    h.press_return()
    time.sleep(2.2)
    h.type_text("file /home/ubuntu/rent")
    time.sleep(0.55)
    h.press_tab()
    time.sleep(1.2)
    h.press_return()
