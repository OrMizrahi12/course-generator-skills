#!/usr/bin/env python3
"""Film lesson 58: sudo whoami then sudo rm of Sam's /tmp scratch."""
...
VIZ = ROOT / "viz/renders/lesson-58-viz.mp4"
OUT = ROOT / "lesson-58.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    scratch = Path("/tmp/sam-rent-scratch.txt")
    if not scratch.exists():
        run(["sudo", "-n", "-u", "sam", "touch", str(scratch)], check=True)
    ...
    log = open("/tmp/lesson58-ffmpeg.log", "w")
