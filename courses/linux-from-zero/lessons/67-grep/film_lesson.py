#!/usr/bin/env python3
"""Film lesson 67: grep paid and Sep in workshop notes."""
...
VIZ = ROOT / "viz/renders/lesson-67-viz.mp4"
OUT = ROOT / "lesson-67.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson67-ffmpeg.log", "w")
    ...
    time.sleep(1.5)
    h.type_line("grep paid rent-log.txt")
    time.sleep(1.4)
    h.type_line("cat .landlord.txt")
    time.sleep(1.4)
    h.type_line("grep Sep .landlord.txt")
    time.sleep(6.0)
