#!/usr/bin/env python3
"""Film lesson 6: Unix as grandparent, then this box still speaks a file tree and users."""
...
VIZ = ROOT / "viz/renders/lesson-06-viz.mp4"
OUT = ROOT / "lesson-06.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ls /", 0.8, 4.2),
    ("ls /home", 0.6, 2.8),
...
def main() -> None:
    ...
    log = open("/tmp/lesson06-ffmpeg.log", "w")
