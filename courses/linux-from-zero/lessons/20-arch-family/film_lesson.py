#!/usr/bin/env python3
"""Film lesson 20: Arch family pictures, then ls /usr/bin/apt and ls /usr/bin/pacman."""
...
VIZ = ROOT / "viz/renders/lesson-20-viz.mp4"
OUT = ROOT / "lesson-20.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ls /usr/bin/apt", 0.4, 2.8),
    ("ls /usr/bin/pacman", 0.5, 5.0),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson20-ffmpeg.log", "w")
