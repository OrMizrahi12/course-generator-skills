#!/usr/bin/env python3
"""Film lesson 7: GNU project pictures, then ls --version and bash --version."""
...
VIZ = ROOT / "viz/renders/lesson-07-viz.mp4"
OUT = ROOT / "lesson-07.mp4"
W, H = 1920, 1080
COMMANDS = [
    ("ls --version", 0.8, 4.6),
    ("bash --version", 0.8, 3.6),
]
...
def main() -> None:
    ...
    log = open("/tmp/lesson07-ffmpeg.log", "w")
