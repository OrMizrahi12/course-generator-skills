#!/usr/bin/env python3
"""Film lesson 41: inspect FHS dirs and prove the workshop lives under /home."""
...
VIZ = ROOT / "viz/renders/lesson-41-viz.mp4"
OUT = ROOT / "lesson-41.mp4"
W, H = 1920, 1080
...
def main() -> None:
    ...
    log = open("/tmp/lesson41-ffmpeg.log", "w")
    ...
    h.type_line("pwd")
    time.sleep(1.4)
    h.type_line("ls -ld /home /tmp /etc /var /usr /bin")
    time.sleep(2.2)
    h.type_line("ls /home")
    time.sleep(1.6)
    h.type_line("ls /var")
    ...
    time.sleep(1.8)
    h.type_line("ls -l /bin/ls")
    time.sleep(1.8)
    h.type_line("ls /tmp/rent-log.txt")
    time.sleep(1.8)
    h.type_line("ls /etc/rent-log.txt")
    time.sleep(1.8)
    h.type_line("cd ~/linux-workshop")
    time.sleep(1.4)
    h.type_line("pwd")
    time.sleep(1.6)
    h.type_line("realpath .")
    time.sleep(1.8)
    h.type_line("ls -l /home/ubuntu/linux-workshop/rent-log.txt")
    time.sleep(6.0)
